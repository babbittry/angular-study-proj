...
!function (t) {
    "use strict";
    var f = t.escapeEntities, o = t.escapeUriScheme, p = t.dom, e = t.utils, d = p.css, g = p.attr, b = p.is,
        n = e.extend, s = e.each, y = "data-sceditor-emoticon", l = t.command.get, v = {always: 1, never: 2, auto: 3},
        r = {
            bold: {txtExec: ["[b]", "[/b]"]},
            italic: {txtExec: ["[i]", "[/i]"]},
            ...
            font: {
                tags: {font: {face: null}}, styles: {"font-family": null}, quoteType: v.never, format: function (t, e) {
                    var n;
                    return "[font=" + a(n = b(t, "font") && (n = g(t, "face")) ? n : d(t, "font-family")) + "]" + e + "[/font]"
                }, html: '<font face="{defaultattr}">{0}</font>'
            },
            size: {
                tags: {font: {size: null}}, styles: {"font-size": null}, format: function (t, e) {
                    var n = g(t, "size"), r = 2;
            ...
            color: {
                tags: {font: {color: null}}, styles: {color: null}, quoteType: v.never, format: function (t, e) {
                    var n;
            ...
            emoticon: {
                allowsEmpty: !0, tags: {img: {src: null, "data-sceditor-emoticon": null}}, format: function (t, e) {
                    return g(t, y) + e
                }, html: "{0}"
            },
            ...
            url: {
                allowsEmpty: !0, tags: {a: {href: null}}, quoteType: v.never, format: function (t, e) {
                    t = g(t, "href");
            ...
            email: {
                quoteType: v.never, html: function (t, e, n) {
                    return '<a href="mailto:' + (f(e.defaultattr, !0) || n) + '">' + n + "</a>"
                }
            },
            quote: {
                tags: {blockquote: null}, isInline: !1, quoteType: v.never, format: function (t, e) {
    ...
    var E = "open", B = "content", I = "newline", C = "close";
    ...
    function T(t) {
        ...
        m.opts = n({}, T.defaults, t), m.tokenize = function (t) {
            ...
            return function t(e) {
                ...
                } else f += n.val; else f += n.val, n.children && (f += t(n.children)), n.closing && (f += n.closing.val);
                return f
            }(m.parse(t, e))
        }
    }
    ...
    function h() {
        var u = this, i = (u.stripQuotes = a, {}), h = {
            ul: ["li", "ol", "ul"],
            ol: ["li", "ol", "ul"],
            table: ["tr"],
            tr: ["td", "th"],
        ...
        function m(l, o, e) {
            function a(t) {
                var e = t[0], t = t[1], n = p.getStyle(l, e), r = l.parentNode;
                return !(!n || r && p.hasStyle(r, e, n)) && (!t || t.includes(n))
            }

            function t(t) {
                i[t] && i[t][e] && s(i[t][e], function (t, e) {
                    var n, r = x[t].strictMatch, i = (r = void 0 === r ? u.opts.strictMatch : r) ? "every" : "some";
        ...
        function c(t, e) {
            function d(t, u, c) {
                ...
                return p.traverse(t, function (t) {
                    var e = "", n = t.nodeType, r = t.nodeName.toLowerCase(), i = "code" === r,
                        l = "img" === r && !!g(t, y), o = h[r], a = t.firstChild, s = !0;
                    c && (s = -1 < c.indexOf(r), (s = l ? !0 : s) || (o = c)), 1 === n ? b(t, ".sceditor-nlf") && !a || ("iframe" !== r && (e = d(t, u || i, o)), s ? (u && !l || (i || (e = m(t, e, !1)), e = m(t, e, !0)), f += function (t, e) {
                        var n = t.nodeName.toLowerCase(), r = p.isInline;
                        if (!r(t, !0) || "br" === n) {
        ...
        function e(t, e, n, r) {
            n = n || document;
            var i, l = !!p.closest(r, "code"), o = n.createElement("div"), a = n.createElement("div"),
        ...
        u.init = function () {
            u.opts = this.opts, u.elementToBbcode = c, s(x, function (n, t) {
                var r = !1 === t.isInline, t = x[n].tags, e = x[n].styles;
