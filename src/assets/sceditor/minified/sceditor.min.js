...
!function () {
    ...
    var ve = i.bind(null, "string"), Ke = i.bind(null, "undefined"), Xe = i.bind(null, "function"),
    ...
    function ut(e, t) {
        var n = (t = t || document).createDocumentFragment(), o = Ce("div", {}, t);
    ...
    function mt(e) {
        d(e, function (e) {
            var t = !Ie(e, !0) && e.nodeType !== s, n = e.parentNode;
    ...
    function ht(e) {
        var t, n, o, r, i, a, l = Re(e, "whiteSpace"), c = /line$/i.test(l), s = e.firstChild;
    ...
    var Pe = {
        ...
        underline: {exec: "underline", tooltip: "Underline", shortcut: "Ctrl+U"},
        ...
        left: {
            ...
            }, exec: "justifyleft", tooltip: "Align left"
        },
        ...
        right: {
            ...
            }, exec: "justifyright", tooltip: "Align right"
        },
        ...
        table: {
            exec: function (e) {
                ...
                Ne(i, Be("table", {
                    ...
                    var t = Number(ke(i, "#rows")[0].value), n = Number(ke(i, "#cols")[0].value), o = "<table>";
        ...
        horizontalrule: {exec: "inserthorizontalrule", tooltip: "Insert a horizontal rule"},
        code: {
            exec: function () {
        ...
        emoticon: {
            exec: function (u) {
                function d(e) {
                    var n, t = f.opts, o = t.emoticonsRoot || "", r = t.emoticonsCompat, i = f.getRangeHelper(),
                        a = r && " " !== i.getOuterText(!0, 1) ? " " : "",
                        l = r && " " !== i.getOuterText(!1, 1) ? " " : "", c = Ce("div"), s = Ce("div"),
                    ...
                    }), !e && t.emoticons.more && (Ne(i = Ce("a", {className: "sceditor-more"}), document.createTextNode(f._("More"))), De(i, "click", function (e) {
        ...
        youtube: {
            _dropDown: function (r, e, i) {
                ...
                Ne(a, Be("youtubeMenu", {
                    ...
                    var t = ke(a, "#link")[0].value, n = t.match(/(?:v=|v\/|embed\/|youtu.be\/)?([a-zA-Z0-9_-]{11})/),
                        t = t.match(/[&|?](?:star)?t=((\d+[hms]?){1,3})/), o = 0;
        ...
        ltr: {
            state: function (e, t) {
                ...
                var e = this.getRangeHelper(), t = e.getFirstBlockParent();
        ...
        maximize: {
            state: function () {
                ...
                this.maximize(!this.maximize()), this.focus()
            }, tooltip: "Maximize", shortcut: "Ctrl+Shift+M"
        },
        source: {
            state: function () {
                ...
                this.toggleSourceMode(), this.focus()
            }, tooltip: "View source", shortcut: "Ctrl+Shift+S"
        },
        ignore: {}
    }, w = {};
    ...
    function Tt(r, e, i) {
        var a, l, c = e || r.contentDocument || r.document, s = "sceditor-start-marker", u = "sceditor-end-marker",
            g = this;
        g.insertHTML = function (e, t) {
            ...
            var e, t = g.selectedRange(), n = g.getMarker(s), o = g.getMarker(u);
            if (!n || !o || !t) return !1;
    ...
    var T, C, e, t = navigator.userAgent, Ct = /iPhone|iPod|iPad| wosbrowser\//i.test(t),
    ...
    var k, D = Object.hasOwnProperty, M = Object.setPrototypeOf, A = Object.isFrozen, R = Object.getPrototypeOf,
        _ = Object.getOwnPropertyDescriptor, je = Object.freeze, n = Object.seal, O = Object.create,
        t = "undefined" != typeof Reflect && Reflect, F = (F = t.apply) || function (e, t, n) {
            return e.apply(t, n)
        }, je = je || function (e) {
            return e
        }, n = n || function (e) {
            ...
            return S(e, Ue(t))
        }, Nt = o(Array.prototype.forEach), kt = o(Array.prototype.pop), Dt = o(Array.prototype.push),
        Mt = o(String.prototype.toLowerCase), At = o(String.prototype.toString), Rt = o(String.prototype.match),
        We = o(String.prototype.replace), _t = o(String.prototype.indexOf), Ot = o(String.prototype.trim),
        Ve = o(RegExp.prototype.test), Ft = (k = TypeError, function () {
    ...
    var It = je(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        ...
        Yt = n(/\{\{[\w\W]*|[\w\W]*\}\}/gm), Kt = n(/<%[\w\W]*|[\w\W]*%>/gm), Xt = n(/\${[\w\W]*}/gm),
        Zt = n(/^data-[\-\w.\u00B7-\uFFFF]/), Jt = n(/^aria-[\-\w]+$/),
        Qt = n(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        en = n(/^(?:\w+script|data):/i), tn = n(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
        nn = n(/^html$/i);
    var on = function L(e) {
        ...
        if (s.version = "2.4.3", s.removed = [], l && l.document && 9 === l.document.nodeType) {
            var c = l.document, r = l.document, I = l.DocumentFragment, e = l.HTMLTemplateElement, u = l.Node,
                z = l.Element, t = l.NodeFilter,
                B = void 0 === (n = l.NamedNodeMap) ? l.NamedNodeMap || l.MozNamedAttrMap : n, P = l.HTMLFormElement,
                U = l.DOMParser, d = l.trustedTypes, j = Lt(n = z.prototype, "cloneNode"), W = Lt(n, "nextSibling"),
                V = Lt(n, "childNodes"), f = Lt(n, "parentNode"),
                ...
                }(d, c)), m = p ? p.createHTML("") : "", e = r, G = e.implementation, q = e.createNodeIterator,
                $ = e.createDocumentFragment, Y = e.getElementsByTagName, K = c.importNode, n = {};
            try {
            ...
            var X, h, g, o = {},
                ...
                J = Kt, Q = Xt, ee = Zt, te = Jt, ne = en, oe = tn, re = Qt, y = null,
                ie = Ge({}, [].concat(Ue(It), Ue(zt), Ue(Bt), Ue(Ut), Ue(Wt))), v = null,
                ae = Ge({}, [].concat(Ue(Vt), Ue(Gt), Ue(qt), Ue($t))), b = Object.seal(Object.create(null, {
                    tagNameCheck: {
                        writable: !0,
                        configurable: !1,
                        enumerable: !0,
                ...
                })), w = null, le = null, ce = !0, se = !0, ue = !1, x = !1, T = !1, de = !1, fe = !1, C = !1, E = !1,
                S = !1, pe = !0, me = !1, he = "user-content-", ge = !0, N = !1, i = {}, k = null,
                ...
                ve = null, be = Ge({}, ["audio", "video", "img", "source", "image", "track"]), we = null,
                xe = Ge({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
                D = "http://www.w3.org/1998/Math/MathML", M = "http://www.w3.org/2000/svg",
                A = "http://www.w3.org/1999/xhtml", R = A, Te = null, Ce = Ge({}, [D, M, A], At),
                Ee = ["application/xhtml+xml", "text/html"], a = null, Se = r.createElement("form"), Ne = function (e) {
                ...
                Ae = Ge({}, ["title", "style", "font", "a", "script"]), _ = Ge({}, zt),
                Re = (Ge(_, Bt), Ge(_, Pt), Ge({}, Ut)), O = (Ge(Re, jt), function (t) {
                    ...
                    if (H("beforeSanitizeElements", e, null), (!((i = e) instanceof P) || "string" == typeof i.nodeName && "string" == typeof i.textContent && "function" == typeof i.removeChild && i.attributes instanceof B && "function" == typeof i.removeAttribute && "function" == typeof i.setAttribute && "string" == typeof i.namespaceURI && "function" == typeof i.insertBefore && "function" == typeof i.hasChildNodes) && !Ve(/[\u0080-\uFFFF]/, e.nodeName)) {
                        ...
                        if (H("uponSanitizeElement", e, {
                            ...
                            if (ge && !k[i]) {
                                var a = f(e) || e.parentNode, l = V(e) || e.childNodes;
                    ...
                    if (t) {
                        for (var n = {
                            ...
                            var r = (l = t[o]).name, i = l.namespaceURI, a = "value" === r ? l.value : Ot(l.value),
                                l = g(r);
        ...
        return s
    }(), qe = window, $e = document, rn = /^image\/(p?jpe?g|gif|png|bmp)$/i;
    ...
    function Ye(r, e) {
        var a, w, u, i, o, f, d, l, c, s, p, t, m, h, g, y, v, L, I, n, b, z, B, x, T, P, U, j, W, V, G, q, $, Y, K, X,
            Z, J, Q, ee, C, te, ne, oe, re, ie, E, ae, S, le, ce, se, ue, de, fe, N, pe, k, me, D, M = this, A = {},
            he = [], R = [], _ = {}, ge = {}, O = {},
        ...
        ye.addHook("uponSanitizeElement", function (e, t) {
            ...
            r._sceditor = M, F.locale && "en" !== F.locale && W(), Oe(w = Ce("div", {className: "sceditor-container"}), r), Re(w, "z-index", F.zIndex), I = r.required, r.required = !1;
            ...
            var e = Ct ? " ios" : "", e = ((d = i.contentDocument).open(), d.write(Be("html", {
                    attrs: ' class="' + e + '"',
            ...
            var e = r.form, t = "compositionstart compositionend",
            ...
            var i, a = M.commands, l = (F.toolbarExclude || "").split(","), e = F.toolbar.split("|");
            u = Ce("div", {
                className: "sceditor-toolbar",
                unselectable: "on"
            }), F.icons in Ye.icons && (T = new Ye.icons[F.icons]), we(e, function (e, t) {
                i = Ce("div", {className: "sceditor-group"}), we(t.split(","), function (e, t) {
                    var n, o, r = a[t];
                    !r || -1 < l.indexOf(t) || (n = r.shortcut, o = Be("toolbarButton", {
                        ...
                        name: t,
                        state: r.state
                    }) : ve(r.exec) && R.push({name: t, state: r.exec}), Ne(i, o), ge[t] = o)
                }), i.firstChild && Ne(u, i)
            }), Ne(F.toolbarContainer || w, u)
        }, $ = function () {
            var e = Ce("div", {className: "sceditor-grip"}), t = Ce("div", {className: "sceditor-resize-cover"}),
                n = "touchmove mousemove", o = "touchcancel touchend mouseup", r = 0, i = 0, a = 0, l = 0, c = 0, s = 0,
                u = at(w), d = Le(w), f = !1, p = M.rtl(), m = F.resizeMinHeight || d / 1.5,
                h = F.resizeMaxHeight || 2.5 * d, g = F.resizeMinWidth || u / 1.25, y = F.resizeMaxWidth || 1.25 * u,
                v = function (e) {
                    l = ("touchmove" === e.type ? (e = qe.event, a = e.changedTouches[0].pageX, e.changedTouches[0]) : (a = e.pageX, e)).pageY;
                    var t = s + (l - i), n = p ? c - (a - r) : c + (a - r);
            ...
            var e = F.emoticons, n = F.emoticonsRoot || "";
            ...
            }, F.dropDownCss), Re(c = Ce("div", {className: "sceditor-dropdown " + t}), e), Ne(c, n), Ne(w, c), De(c, "click focusin", function (e) {
                e.stopPropagation()
            ...
            if (r) {
                ...
                setTimeout(function () {
                    var e = o.innerHTML;
                    o.innerHTML = "", Ne(o, x), o.scrollTop = s, x = !1, m.restoreRange(), Z({html: H(e)})
                }, 0)
            }
        }, Z = function (e) {
            var t = Ce("div", {}, d),
                e = (h.call("pasteRaw", e), lt(w, "pasteraw", e), e.html ? (t.innerHTML = H(e.html), mt(t)) : t.innerHTML = ze(e.text || ""), {val: t.innerHTML}),
            ...
            F.emoticonsEnabled && (e = f, l = O, c = F.emoticonsCompat, s = e.ownerDocument, t = "(^|\\s| | | | |$)", u = [], d = {}, Je(e, "code") || (we(l, function (e) {
                ...
                for (t = t.firstChild; t;) {
                    if (t.nodeType !== xe || _e(t, "code") || e(t), t.nodeType === Te) for (var n = 0; n < u.length; n++) {
                        var o, r = t.nodeValue, i = u[n], a = c ? r.search(d[i]) : r.indexOf(i);
            ...
            function e() {
                if (o.getSelection() && o.getSelection().rangeCount <= 0) v = null; else if (m && !m.compare(v)) {
                    if ((v = m.cloneSelected()) && v.collapsed) {
                        var e = v.startContainer, t = v.startOffset;
            ...
            g !== t && (e = g, g = t, y = m.getFirstBlockParent(t), lt(w, "nodechanged", {oldNode: e, newNode: g}))
        }, M.currentNode = function () {
            return g
        }, M.currentBlockNode = function () {
            return y
        }, E = function () {
            var e, t, n = "active", o = d, r = M.sourceMode();
            if (M.readOnly()) we(ke(u, n), function (e, t) {
                it(t, n)
            }); else {
                r || (t = m.parentNode(), e = m.getFirstBlockParent(t));
                for (var i = 0; i < R.length; i++) {
                    var a = 0, l = ge[R[i].name], c = R[i].state, s = r && !l._sceTxtMode || !r && !l._sceWysiwygMode;
                    if (ve(c)) {
                        if (!r) try {
            ...
            var n = 0, o = M.emoticonsCache, t = String.fromCharCode(e.which);
            ...
            var e = y, t = m, n = /[^\s\xA0\u2002\u2003\u2009]+/, o = e && ke(e, "img[data-sceditor-emoticon]");
            if (e && o.length) for (var r = 0; r < o.length; r++) {
                var i, a, l, c, s = o[r], u = s.parentNode, d = s.previousSibling, f = s.nextSibling;
            ...
            return e || !1 === e ? ((F.emoticonsEnabled = e) ? (De(f, "keypress", ue), M.sourceMode() || (m.saveRange(), P(), N(!1), m.restoreRange())) : (we(ke(f, "img[data-sceditor-emoticon]"), function (e, t) {
                var n = ot(t, "sceditor-emoticon"), n = d.createTextNode(n);
                t.parentNode.replaceChild(n, t)
            }), Me(f, "keypress", ue), N()), M) : F.emoticonsEnabled
        }, M.css = function (e) {
            return n || (n = Ce("style", {id: "inline"}, d), Ne(d.head, n)), ve(e) ? (n.styleSheet ? n.styleSheet.cssText = e : n.innerHTML = e, M) : n.styleSheet ? n.styleSheet.cssText : n.innerHTML
        }, J = function (e) {
            var t = [], n = {
                "`": "~",
                1: "!",
            ...
            var t, n, o;
            h && (h.hasHandler("valuechangedEvent") || N.hasHandler) && (o = !(n = M.sourceMode()) && m.hasSelection(), e = (s = !1) !== e && !d.getElementById("sceditor-start-marker"), p && (clearTimeout(p), p = !1), o && e && m.saveRange(), (t = n ? l.value : f.innerHTML) !== N.lastVal && (N.lastVal = t, lt(w, "valuechanged", {rawValue: n ? M.val() : t})), o && e && m.removeMarkers())
        }, pe = function () {
            p && N()
        }, k = function (e) {
